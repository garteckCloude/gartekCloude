    ...
    <section>
        <div className="mt-[650px]">
            <div className="flex flex-col items-center justify-center leading-normal text-5xl">
                <p className="font-extrabold lg:text-6xl text-3xl">We Are <span className="text-[#FFA500]">Revolutionnizing</span></p>
            ...
            <div className="flex flex-col items-center text-slate-500 mt-5">
                <p className="text-center">Collaborate, Access Comprehensive & Organised course Materials, create connections & build Communities with Gartekcloude</p>
            </div>
